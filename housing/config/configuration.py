...
class Configuration:
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        try:
            ...
            data_validation_artifact_dir=os.path.join(artifact_dir,DATA_VALIDATION_ARTIFACT_DIR_NAME,self.time_stamp) ## This will be final path for all files of data validation
            data_validation_config=self.config_info[DATA_VALIDATION_CONFIG_KEY]

            report_file_path=os.path.join(data_validation_artifact_dir,data_validation_config[DATA_VALIDATION_REPROT_FILE_NAME_KEY])
    ...
    def get_data_transformation_config(self)->DataTransformationConfig:
        try:
            artifact_dir=self.training_pipeline_config.artifact_dir
            data_transformation_artifact_dir=os.path.join(artifact_dir,DATA_TRANSFORMATION_ARTIFACT_DIR_NAME,self.time_stamp)
            ...
            logging.info(f"Data Transformation Configuration Completed\nData Transformation Config-[{data_transformation_config}]")
    ...
    def get_model_pusher_config(self)->ModelPusherConfig:
        try:
            ...
            export_dir_path=os.path.join(ROOT_DIR,model_pusher_config_info[MODEL_PUSHER_EXPORT_DIR_KEY],time_stamp)
